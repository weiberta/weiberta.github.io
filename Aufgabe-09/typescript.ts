...
let crc2haus: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2dach: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2sonne: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2lift: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2wolke: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2huegel: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2besucher: CanvasRenderingContext2D = canvas.getContext("2d");
let crc2schnee: CanvasRenderingContext2D = canvas.getContext("2d");
...
// >>>>> SONNE
        ...
        let gradient: CanvasGradient = crc2sonne.createRadialGradient(500, 0, r1, 100, 0, r2);
...
// >>>>> SCHNEE-PARTIKEL  (später Funktion mit random)
    ...
    crc2schnee.fill();
    crc2schnee.stroke();crc2schnee.beginPath();
