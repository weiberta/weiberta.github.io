...
// Object = Komplexer Datentyp auf Grundlage primitiver Datentypen (string, array, number)
...
{
    let generatedMonsterName : string;    // FEHLER " " - unnötig              // Erstelle einen leeren String für das Monster
