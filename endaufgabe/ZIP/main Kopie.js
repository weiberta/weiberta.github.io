...
let stapel = [];                                                                                                         // Kartenstapel Array
let spielerHand = [];                                                                                                    // Spieler Hand Array
let computerHand = [];                                                                                                   // Computer Hand Array
let ablage = [];                                                                                                         // Kartenablage Array

let spielbareKarte;                                                                                                      // Buffer für spielbare Karte des Computers
...
function spielbar(gelegteKarte) {                                                                                        // Kartenobjekt Parameterübergabe
