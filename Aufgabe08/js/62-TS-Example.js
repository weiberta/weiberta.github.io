...
let Bildquellen = ["p1.png", "g5.gif", "g3.gif", "g2.gif", "g7.gif"];
...
generateMonster = () => {
    ...
    function monsterGenerateHTML(count) {
        ...
        let monsterCount = count; // Die aktuelle Anzahl vorhandener Monster, zudem auch die neue Zahl fÃ¼r das Monster-Array.
    ...
    function generateMonsterName() {
        ...
        let rngNumber = getRNGNumber({ _maxNumber: prefix.length }); // Der Rückgabewert der Funktion wird hier verwendet um den entsprechenden Teil des Namens (hier: Anfang) zu generieren.
    ...
    function generateMonsterHitPoints() {
        ...
        let tempMonsterHP = 1 + getRNGNumber({ _maxNumber: 10 });
    ...
    function generateMonsterXP() {
        ...
        let tempMonsterXP = 100 + getRNGNumber({ _maxNumber: 350 });
